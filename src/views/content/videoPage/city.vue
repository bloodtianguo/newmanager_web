...
import { cityVideoListAPI,updateShelvesAPI,batchUpdateShelvesAPI, addOfficealVideoAPI } from '@/api/content/recreation'
...
export default {
    ...
    coverClose(val){
      this.coverVisible=val
        ...
        async getData(){
            ...
            let res = await cityVideoListAPI(params)
        ...
        goVideoDetails({videoId}){
            ...
            this.$router.push({path:'/videoContentManage/city/videoDetails',query:{videoId}})
        },
    ...
            }
        ...
        currentPageHandle(){
            this.currentPageIsShow = this.$route.path == '/videoContentManage/city'
        }
